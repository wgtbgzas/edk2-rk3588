...
#define THERMAL_PROFILE_MAX     0
#define THERMAL_PROFILE_MEDIUM  1
#define THERMAL_PROFILE_SLOW    2
#define THERMAL_PROFILE_CUSTOM  3
typedef struct {
  UINT32    Mode;
} THERMAL_PROFILE_MODE_VARSTORE_DATA;

typedef struct {
  UINT32    Mhz;
} THERMAL_PROFILE_CUSTOM_CLOCK_VARSTORE_DATA;
...
#define PCIE_LINK_SPEED_MAX_AUTO  0
#define PCIE_LINK_SPEED_MAX_GEN1  1
#define PCIE_LINK_SPEED_MAX_GEN2  2
#define PCIE_LINK_SPEED_MAX_GEN3  3
typedef struct {
  UINT32    Mode;
} PCIE_LINK_SPEED_MAX_VARSTORE_DATA;
